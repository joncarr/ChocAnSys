...
public class DeleteProviderViewController {
    ...
    Provider provider;
    @FXML
    private Label lblProviderNumber;
    @FXML
    private Label lblProviderFirstName;
    @FXML
    private Label lblProviderLastName;
    @FXML
    private Label lblProviderStreet;
    @FXML
    private Label lblProviderCity;
    @FXML
    private Label lblProviderZipCode;
    @FXML
    private Label lblProviderState;
    @FXML
